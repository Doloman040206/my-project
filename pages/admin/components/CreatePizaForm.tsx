  ...
  return (
    <div>
      <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
        <label htmlFor="nameInput" style={{ marginRight: '12px', fontSize: '1.2rem' }}>
          Name:
        </label>
        <input
          id="nameInput"
      ...
      <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
        <label
          ...
          style={{ marginRight: '10px', fontSize: '1.2rem', marginLeft: '-35px' }}
        >
          Ingridients:
        </label>
        <input
      ...
      <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
        <label htmlFor="priceInput" style={{ marginRight: '20px', fontSize: '1.2rem' }}>
          Price:
        </label>
        <input
          id="priceInput"
